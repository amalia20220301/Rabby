...
const QRHardWareWaiting = () => {
  ...
  const init = useCallback(async () => {
    ...
    eventBus.addEventListener(EVENTS.QRHARDWARE.ACQUIRE_MEMSTORE_FAILED, () => {
      rejectApproval('Acquire sign request data failed');
    });
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      eventBus.removeAllEventListeners(
        EVENTS.QRHARDWARE.ACQUIRE_MEMSTORE_FAILED
      );
    };
  }, [init]);
